...
class QueryTest < Test::Unit::TestCase
  ...
  QUERY = KBraspag::Response::Query

  COMPLETE_PAYMENT_SLIP = KBraspag::Response::CompletePaymentSlip

  SIMPLIFIED_CREDIT_CARD = KBraspag::Response::SimplifiedCreditCard

  SIMPLIFIED_DEBIT_CARD = KBraspag::Response::SimplifiedDebitCard

  ERRORS = KBraspag::Response::Default::Errors
