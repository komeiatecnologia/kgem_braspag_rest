  ...
  module Request
    module Default
      class CreditCard
        ...
        @@VALID_CARD_NUMBER_FORMAT = /\A\d{16}\z|\A\d{14}\z/.freeze
        ...
        def valid_card_number_format?(value)
          raise ArgumentError, "Invalid card number format: #{value}, expected 1111222233334444(14 or 16 digits)", "#{self.class}" if value !~ @@VALID_CARD_NUMBER_FORMAT
          true
        end
