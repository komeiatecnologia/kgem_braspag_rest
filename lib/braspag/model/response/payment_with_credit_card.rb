module Braspag
  module Model
    module Response
      ...
      require 'lib/braspag/model/response/credit_card'

      class PaymentWithCreditCard < Braspag::Model::Response::Payment
        ...
        def initialize(hash)
          ...
          @credit_card = Braspag::Model::Response::CreditCard.new(hash['CreditCard'])
